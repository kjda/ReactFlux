	...
	_createAction: function(name, constant, callback){
		return function(){
			...
			Promise.resolve(resp).then(function(payload){
				var successConstant = constant + constantsConfigs.separator + constantsConfigs.successSuffix;
				this._dispatcher.dispatch(successConstant, payload);
			}.bind(this), function(error){
				var failConstant = constant + constantsConfigs.separator + constantsConfigs.failSuffix;
				this._dispatcher.dispatch(failConstant, error);
			}.bind(this));
		}.bind(this);
	}
